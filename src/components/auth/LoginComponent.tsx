  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const users: User[] = JSON.parse(responseBody);
        ...
        <div className="flex justify-center">
          <div className="w-full max-w-md px-4">
            <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-gray-800 sm:p-12">
              <h2 className="mb-6 text-center text-[32px] font-bold uppercase text-dark dark:text-white">
                Admin login
              </h2>
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  <label className="block mb-2 text-sm font-semibold text-dark dark:text-gray-400">
                    Email
                  </label>
                  <div className="flex items-center border border-gray-300 rounded-lg dark:border-gray-600">
                    <FaUserAlt className="w-5 h-5 ml-3 text-primary dark:text-primary-300" />
                    <input
                      type="text"
                      name="username"
                      ...
                      className="w-full p-3 bg-white border-none rounded-lg dark:bg-gray-800 dark:text-white focus:ring-0"
                    />
                  </div>
                </div>
                <div className="mb-6">
                  ...
                  <div className="flex items-center border border-gray-300 rounded-lg dark:border-gray-600">
                    <FaLock className="w-5 h-5 ml-3 text-primary dark:text-primary-300" />
                    <input
                      type="password"
                      name="password"
