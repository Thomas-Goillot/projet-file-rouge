...
const ContactComponent = () => {
  return (
      <section className="relative z-10 overflow-hidden bg-white py-20 my-2 px-4 dark:bg-dark">
        <div className="container">
          <div className="-mx-4 flex flex-wrap lg:justify-between">
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                <h2 className="mb-6 px-6 text-[32px] font-bold uppercase  sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                    Besoin d'aide ?
                </h2>
                <span className="mb-4 px-6 block text-base font-semibold text-primary">
                  Nous contacter
                </span>

                <p className="mb-9 px-6 text-base leading-relaxed text-body-color dark:text-dark-6">
              ...
              <div className="relative rounded-lg bg-white p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-primary bg-primary p-3 transition"
                    >
                      Envoyer
                    </button>
                  </div>
